                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number"  id="cantidad" value="1" name="cantidad" class="form-control" required>
                                        @error('cantidad')
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="nom_cliente" type="text" name="" class="form-control" value="S/N">  
                               
                                    </div>

                                    <div class="col-md-6">
                                        <label for="">Nit del cliente</label>
                                        <input id="nit_cliente" type="text" name="" class="form-control" value="0">  
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            // Si hay mensaje adicional (stock mínimo), lo mostramos
                            if (response.advertencia) {
                                Swal.fire({
                                    icon: "warning",
                                    title: "Stock mínimo",
                                    text: response.advertencia,
                                    timer: 3000,
                                    showConfirmButton: false,
