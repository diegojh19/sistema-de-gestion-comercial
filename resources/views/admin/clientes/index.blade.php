                ...
                <div class="card-header">
                    <h3 class="card-title">Clientes Registrados</h3>
                        <div class="card-tools">
                            <a href="{{url('admin/clientes/reporte')}}" class="btn btn-danger" target="_blank"><i class="fa fa-file-pdf"></i>
                                Reporte
                            </a>
                            <a href="{{url('admin/clientes/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                Registrar nuevo
                            </a>
                        </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url('admin/clientes/'.$cliente->id)}}" class="btn btn-info"><i class="fas fa-eye"></i></a>
                                        <a href="{{url('admin/clientes/'.$cliente->id.'/edit')}}" class="btn btn-success"><i class="fas fa-pencil"></i></a>
