...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <form action="{{(url('/admin/compras',$compras->id))}}" id="form_compra" method="post">
                    @csrf
                    @method('PUT')
                    <input type="text" value="{{$compras->id}}" id="id_compra" name="id_compra" hidden>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="proveedor" type="text" name="" value="{{$compras->proveedor->empresa}}" class="form-control" disabled>  
                                        <input id="id_proveedor" type="text" name="id_proveedor" value="{{$compras->proveedor->id}}" class="form-control" hidden>                                 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fecha" value="{{$compras->fecha}}" class="form-control" >
                                        @error('fecha')
                                            <small class="text-danger">{{$message}}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="comprobante" value="{{$compras->comprobante}}" class="form-control" >
                                        @error('comprobante')
                                            <small class="text-danger">{{$message}}</small>
                                        @enderror
                                    </div>
