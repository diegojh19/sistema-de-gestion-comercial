                ...
                <div class="card-header">
                    <h3 class="card-title">Compras Registradas</h3>
                        <div class="card-tools">
                            <a href="{{url('admin/compras/reporte')}}" class="btn btn-danger" target="_blank"><i class="fa fa-file-pdf"></i>
                                Reporte
                            </a>

                            @if ($arqueoAbierto)
                            <a href="{{url('admin/compras/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                Registrar nuevo
                            </a>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url('admin/compras/'.$compra->id)}}" class="btn btn-info"><i class="fas fa-eye"></i></a>
                                        <a href="{{url('admin/compras/'.$compra->id.'/edit')}}" class="btn btn-success"><i class="fas fa-pencil"></i></a>
