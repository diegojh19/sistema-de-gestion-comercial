        ...
        <table class="table table-bordered" cellpadding="5">
            <thead style="background-color: #cccccc">
                <tr>
                    ...
                    <td width="60px" style="text-align: center"><b>Fecha</b></td>
                    <td width="30px" style="text-align: center"><b>Comprobante</b></td>
                    <td width="50px" style="text-align: center"><b>Precio compra</b></td>
