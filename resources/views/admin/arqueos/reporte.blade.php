    ...
    <div class="content">
        ...
        <table class="table table-bordered" cellpadding="5">
            <thead style="background-color: #cccccc">
                <tr>
                    <td width="10px" style="text-align: center"><b>Nro</b></td>
                    <td width="60px" style="text-align: center"><b>Fecha de apertura</b></td>
                    <td width="30px" style="text-align: center"><b>Monto inicial</b></td>
                    <td width="50px" style="text-align: center"><b>Fecha cierre</b></td>
                    <td width="50px" style="text-align: center"><b>Monto final</b></td>
                    <td width="50px" style="text-align: center"><b>Movimientos</b></td>
                    <td width="40px" style="text-align: center"><b>Descripcion</b></td>
                    <td width="60px" style="text-align: center"><b>Fecha y Hora de registro</b></td>
